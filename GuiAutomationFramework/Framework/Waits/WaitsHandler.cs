...
namespace GuiAutomationFramework.Framework.Waits
{
    /// <summary>
    /// WaitsHandler provides a set of explicit waits operation for handling page and web element synchronization.
    /// </summary>
    public class WaitsHandler
    {
        ...
        public static void WaitForAjaxToComplete(IWebDriver driver)
        {
            ...
            if (ajaxIsPresent)
            {
                try
                {
                    WebDriverWait webDriverWait = new WebDriverWait(driver, ConfigurationReader.FrameworkConfig.GetExplicitlyTimeout());
